---
name: loop-build
description: Implement a scoped Spec Loop task while keeping acceptance, tests, and current state aligned.
---

# Build a specified change

Read [the shared protocol](../spec-loop/references/protocol.md), then [the build guide](../spec-loop/references/build.md). Resolve bundled paths from this skill directory.
