---
name: loop-specify
description: Create or revise a Spec Loop change contract, architecture, data rules, or a baseline spec for existing code.
---

# Write a change contract

Read [the shared protocol](../spec-loop/references/protocol.md), then [the specify guide](../spec-loop/references/specify.md). Resolve bundled paths from this skill directory.
