---
name: loop-plan
description: Turn a Spec Loop contract into ordered implementation tasks with clear scope, dependencies, and verification.
---

# Plan a change

Read [the shared protocol](../spec-loop/references/protocol.md), then [the plan guide](../spec-loop/references/plan.md). Resolve bundled paths from this skill directory.
